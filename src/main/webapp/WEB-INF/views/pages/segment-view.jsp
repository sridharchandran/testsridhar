...
<!-- begin:: Content -->
    ...
    <option value="100">100</option>
		...
		<!-- <script src="assets/js/demo1/pages/crud/keen-datatable/base/data-local.js" type="text/javascript"></script>
		 -->
		<script src="assets/js/demo1/pages/crud/keen-datatable/base/segment.js" type="text/javascript"></script>
